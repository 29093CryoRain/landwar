...
下面的文本可用于 GitHub 仓库首页简介、Release 正文或项目公告。发布版本号、下载链接和截图按实际情况替换。

---

# landwar：领土战争

`landwar` 是一个使用 C++20、SDL2、EnTT 和 Dear ImGui 构建的实时领土战争模拟游戏。
...
这是一个持续完善中的翻新版项目。快照版本采用严格匹配策略，跨版本读档不保证兼容；窗口模式默认使用
